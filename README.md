...
Outputs are:
 - OutputFile.ClustScore --> The clustering score for each k, for each window  (davies bouldin [default] or silhouette score)
...
The plots are: 
 ...
 - b. The clutering score for each value of k. At a supergene or an inversion polymorphism, the score is best for k=2 or k=3. Be careful that by default, the script compute the davies bouldin score. A lower davies bouldin score indicate a better clutering whereas, in contrary, this is an higher silhouette score that indicate a better clustering
